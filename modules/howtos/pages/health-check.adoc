...
:page-toclevels: 2
:lang: C++
:example-source: devguide:example$cxx/src/health_check.cxx
...
[source,c++]
----
include::cxx-sdk:devguide:example$cxx/src/health_check.cxx[tag=ping]
----
...
----
include::{example-source}[indent=0,tag=diagnostics]
----
