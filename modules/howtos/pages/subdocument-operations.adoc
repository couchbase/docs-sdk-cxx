...
[source,c++]
----
include::devguide:example$cxx/src/subdocument.cxx[tag=lookupinanyreplica,indent=0]
----
...
[source,c++]
----
include::devguide:example$cxx/src/subdocument.cxx[tag=lookupinallreplicas,indent=0]
----
////
