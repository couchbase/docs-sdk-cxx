...
The Couchbase {cpp} SDK works together with the https://github.com/couchbase/java-couchbase-encryption[{cpp} Couchbase Encryption^] library to provide support for encryption and decryption of JSON Object fields.
