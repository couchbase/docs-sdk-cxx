...
This feature is available in the {cpp} SDK from xref:1.2@howtos:encrypting-using-sdk.adoc[version 1.2.0].
For a high-level overview of this feature, see xref:1.2@concept-docs:encryption.adoc[].
