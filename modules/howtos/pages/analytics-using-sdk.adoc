...
try Couchbase Analytics using the C++ SDK.
...
Rows can be returned as JSON representations from multiple third party C++ libraries, directly as a user defined class, and more.
