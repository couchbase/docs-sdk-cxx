...
It is possible to query off the xref:{version-common}@server:learn:data/scopes-and-collections.adoc[`scope` level] with _Couchbase Server version 7.0_ onwards,
