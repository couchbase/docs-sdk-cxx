...
[NOTE]
=====
Most of the examples here use the simplest of the two asynchronous APIs provided by the C++ SDK, which returns an `std::future`.  There's also a callback-based asynchronous, for which we'll see an example later.
=====
