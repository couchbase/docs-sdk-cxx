...
////
Worth knowing that they only log slower queries by default.  But it should include timed out ones (as long as they hit query service, of course), which will be very useful (edited) 
////