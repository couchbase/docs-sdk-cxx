...
In the next part of the tutorial, you're going to begin your exploration of Couchbase by signing up for Capella and deploying a perpetual free tier operational cluster.
...
With free tier you'll get a forever free operational cluster of three nodes, featuring the Data Service, Query Service, and Index Service --
all that you need to follow along with this tutorial.


=== Capella Installation

Sign up to https://www.couchbase.com/products/capella[the Couchbase Capella cloud service] and deploy a perpetual free tier operational cluster. With your account and free cluster, you can then run through the tutorials for xref:cloud:get-started:get-started.adoc[Getting Started with Couchbase Capella].
