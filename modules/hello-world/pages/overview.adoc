...
Couchbase is a data platform with a large surface area, which is reflected by the depth of the SDK.
There's plenty to explore in these docs, but if you're in a hurry to get started head straight to xref:hello-world:start-using-sdk.adoc[].
