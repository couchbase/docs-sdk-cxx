...
+
--
If you haven't already got a database set up, the easiest route is to https://cloud.couchbase.com/sign-up[sign up to Couchbase Capella and deploy a perpetual free tier operational cluster^],
