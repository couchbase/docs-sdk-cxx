...
// https://asterixdb.apache.org/docs/0.9.8/sqlpp/manual.html#Introduction
// "...SQL++, a declarative query language for JSON data which is largely backwards compatible with SQL..."
