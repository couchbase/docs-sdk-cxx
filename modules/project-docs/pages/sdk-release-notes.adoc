...
Ensure DNS-SRV resolver reports timeouts (https://github.com/couchbase/couchbase-cxx-client/pull/703[#703])

* Expose server group replica read in transaction_context (https://github.com/couchbase/couchbase-cxx-client/pull/704[#704])


==== Build and Test Infrastructure

* https://jira.issues.couchbase.com/browse/CXXCBC-638[CXXCBC-638]:
Fix transactions examples test (https://github.com/couchbase/couchbase-cxx-client/pull/710[#710])
...
Do not force debug symbols for release builds (https://github.com/couchbase/couchbase-cxx-client/pull/708[#708])

* https://jira.issues.couchbase.com/browse/CXXCBC-638[CXXCBC-638]:
Switch SDK to use bundled fmtlib for spdlog (https://github.com/couchbase/couchbase-cxx-client/pull/705[#705])

* Update spdlog to 1.15.0 (https://github.com/couchbase/couchbase-cxx-client/pull/709[#709])
