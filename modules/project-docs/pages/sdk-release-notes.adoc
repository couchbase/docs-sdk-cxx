...
Update allowed connection string options (https://github.com/couchbase/couchbase-cxx-client/pull/668[#668])
...
Fix detection of dysfunctional node (https://github.com/couchbase/couchbase-cxx-client/pull/673[#673])

* https://jira.issues.couchbase.com/browse/CXXCBC-574[CXXCBC-574]:
Fix memory leak when open fails in public API (https://github.com/couchbase/couchbase-cxx-client/pull/649[#649])

* https://jira.issues.couchbase.com/browse/CXXCBC-614[CXXCBC-614]:
Fix memory leak in `observe_poll` (https://github.com/couchbase/couchbase-cxx-client/pull/679[#679])

* Add missing template parameters to fix compiler warnings (https://github.com/couchbase/couchbase-cxx-client/pull/671[#671])
...
Add cluster labels & system tag in spans (https://github.com/couchbase/couchbase-cxx-client/pull/682[#682])

* https://jira.issues.couchbase.com/browse/CXXCBC-582[CXXCBC-582]:
Add cluster labels, keyspace & outcome in metrics (https://github.com/couchbase/couchbase-cxx-client/pull/677[#677])
...
Reduce `origin::to_json` output for Columnar builds (https://github.com/couchbase/couchbase-cxx-client/pull/678[#678])

==== Build and Test Infrastructure

* https://jira.issues.couchbase.com/browse/CXXCBC-303[CXXCBC-303]:
Fix RPM for AmazonLinux (https://github.com/couchbase/couchbase-cxx-client/pull/663[#663])

* https://jira.issues.couchbase.com/browse/CXXCBC-303[CXXCBC-303]:
Fix RPM for RHEL 8 (https://github.com/couchbase/couchbase-cxx-client/pull/664[#664])

* Use timestamp from the tag for reproducible tarballs (https://github.com/couchbase/couchbase-cxx-client/pull/665[#665])

* Update list of RPM-based platforms (https://github.com/couchbase/couchbase-cxx-client/pull/676[#676])
