...
Fix pkg-config file (https://github.com/couchbase/couchbase-cxx-client/736[#736]).

* https://jira.issues.couchbase.com/browse/CXXCBC-667[CXXCBC-667]:
Core implementation of prepend/append should encode CAS value (https://github.com/couchbase/couchbase-cxx-client/738[#738]).

* https://jira.issues.couchbase.com/browse/CXXCBC-671[CXXCBC-671]:
Update snappy to support CMake 4.0 (https://github.com/couchbase/couchbase-cxx-client/745[#745]).
