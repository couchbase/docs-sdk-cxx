...
Update core `analytics_link_get_all` to follow RFC (https://github.com/couchbase/couchbase-cxx-client/pull/687[#687])

* https://jira.issues.couchbase.com/browse/CXXCBC-615[CXXCBC-615]:
Expose `insert_raw` and `replace_raw` in core transactions attempt context (https://github.com/couchbase/couchbase-cxx-client/pull/686[#686])

* https://jira.issues.couchbase.com/browse/CXXCBC-622[CXXCBC-622]:
Update OpenTelemetry metrics integration to use GA Metrics API (https://github.com/couchbase/couchbase-cxx-client/pull/688[#688])

* https://jira.issues.couchbase.com/browse/CXXCBC-627[CXXCBC-627]:
Performance degradation after `couchbase::error` changes (https://github.com/couchbase/couchbase-cxx-client/pull/693[#693])

* https://jira.issues.couchbase.com/browse/CXXCBC-624[CXXCBC-624]:
Fix user agent ID generation (https://github.com/couchbase/couchbase-cxx-client/pull/692[#692])
...
Follow RFC naming for metric operation names (https://github.com/couchbase/couchbase-cxx-client/pull/695[#695])

* https://jira.issues.couchbase.com/browse/CXXCBC-632[CXXCBC-632]:
Do not assume Analytics will always send meta fields in response (https://github.com/couchbase/couchbase-cxx-client/pull/699[#699])

* URI encode user_upsert (https://github.com/couchbase/couchbase-cxx-client/pull/700[#700])

==== Features

* https://jira.issues.couchbase.com/browse/CXXCBC-609[CXXCBC-609]:
Expose `parent_span` in Public API options (https://github.com/couchbase/couchbase-cxx-client/pull/690[#690])

==== Build and Test Infrastructure

* Updates for YUM/RPM builders (https://github.com/couchbase/couchbase-cxx-client/pull/691[#691])
* Debian/Ubuntu packaging scripts (https://github.com/couchbase/couchbase-cxx-client/pull/694[#694])
* Fix packaging scripts on MacOS (https://github.com/couchbase/couchbase-cxx-client/pull/698[#698])
* Add scripts to produce APK files for Alpine Linux (https://github.com/couchbase/couchbase-cxx-client/pull/685[#685])
