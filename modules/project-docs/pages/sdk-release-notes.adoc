...
* Server group replica reads are now ecposed in `transaction_context` (https://github.com/couchbase/couchbase-cxx-client/pull/704[#704]).


==== Build and Test Infrastructure

* https://jira.issues.couchbase.com/browse/CXXCBC-638[CXXCBC-638]:
Fixed transactions examples test (https://github.com/couchbase/couchbase-cxx-client/pull/710[#710]).
