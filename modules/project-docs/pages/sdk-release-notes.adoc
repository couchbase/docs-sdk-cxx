...
Do not copy configuration when the operation depends on it (https://github.com/couchbase/couchbase-cxx-client/pull/713[#713], https://github.com/couchbase/couchbase-cxx-client/pull/721[#721]).

* https://jira.issues.couchbase.com/browse/CXXCBC-660[CXXCBC-660]:
Fix potential race condition in the logger (https://github.com/couchbase/couchbase-cxx-client/pull/723[#723])

* https://jira.issues.couchbase.com/browse/CXXCBC-661[CXXCBC-661]:
Reconnect cluster object on fork (https://github.com/couchbase/couchbase-cxx-client/pull/725[#725])
