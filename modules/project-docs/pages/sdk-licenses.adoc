...
see https://github.com/couchbase/docs-sdk-cxx/blob/release/{sdk_dot_minor}/LICENSE[https://github.com/couchbase/docs-sdk-cxx/blob/release/{sdk_dot_minor}/LICENSE].
