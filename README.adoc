...
This repository hosts the documentation source for the https://docs.couchbase.com/cxx-sdk/1.5/hello-world/overview.html[Couchbase {cpp} SDK].

This branch documents the 1.5 release of the SDK.
It follows the https://docs.couchbase.com/cxx-sdk/1.5/project-docs/compatibility.html#api-version[SDK 3.10 API].
