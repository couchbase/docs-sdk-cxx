...
This branch documents the 1.3 release of the SDK.
It follows the https://docs.couchbase.com/cxx-sdk/1.3/project-docs/compatibility.html#api-version[SDK 3.9 API].
...
Production branches use the *release/x.y* naming pattern (e.g. `release/1.3`, `release/1.2`).
