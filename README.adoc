...
This branch documents the 1.2 release of the SDK.
It follows the https://docs.couchbase.com/cxx-sdk/1.0/project-docs/compatibility.html#api-version[SDK 3.8 API].
