...
This repository hosts the documentation source for the https://docs.couchbase.com/cxx-sdk/1.3/hello-world/overview.html[Couchbase {cpp} SDK].

This branch documents the 1.4 release of the SDK.
It follows the https://docs.couchbase.com/cxx-sdk/1.4/project-docs/compatibility.html#api-version[SDK 3.10 API].
...
The philosophy behind the Information Architecture can be found in the https://docs.couchbase.com/cxx-sdk/1.4/project-docs/metadoc-about-these-sdk-docs.html[meta doc].
...
A value of `3` should not be used, save in exceptionally complicated pages like that shown (the https://docs.couchbase.com/cxx-sdk/1.4/project-docs/compatibility.html[compatibility page]).
...
Production branches use the *release/x.y* naming pattern (e.g. `release/1.4`, `release/1.3`).
...
* Update antora.yml
* Update README.adoc
* Update modules/project-docs/pages/compatibility.adoc
* Add new headings in modules/project-docs/pages/sdk-release-notes.adoc
* In modules/howtos/pages/distributed-acid-transactions-from-the-sdk.adoc -- remove the aliases for `cxx-transactions` from the no-longer-latest branch version of this page,so that the alias points to the latest branch only.
* Do a test build ...
* ... And then start to add new content.
